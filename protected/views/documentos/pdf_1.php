...
return $html; exit();
//    <fechaEmision>25/02/2015</fechaEmision>
//    <tipoIdentificacionComprador>05</tipoIdentificacionComprador>
//    <razonSocialComprador>JOSE MARIA VELASCO ESPINOSA</razonSocialComprador>
//    <identificacionComprador>1705335733</identificacionComprador>
//    <obligadoContabilidad>NO</obligadoContabilidad>
//    <codDocModificado>01</codDocModificado>
//    <numDocModificado>002-002-000000612</numDocModificado>
//    <fechaEmisionDocSustento>25/02/2015</fechaEmisionDocSustento>
//    <totalSinImpuestos>2.80</totalSinImpuestos>
//    <valorModificacion>3.14</valorModificacion>
//    <moneda>DOLAR</moneda>
//    <totalConImpuestos>
//      <totalImpuesto>
//        <codigo>2</codigo>
//        <codigoPorcentaje>2</codigoPorcentaje>
//        <baseImponible>2.80</baseImponible>
//        <valor>0.34</valor>
//      </totalImpuesto>
//    </totalConImpuestos>
...
$html.='<td>CI/RUC</td><td>'.$languages->infoNotaCredito->identificacionComprador.'</td>';
$html.='<td>Razon Social</td><td>'.$languages->infoNotaCredito->razonSocialComprador.'</td></tr> ';
$html.='<tr><td width="140px" colspan="3">Comprobante que se modifica</td><td colspan="2">'. $tipodoc.' '.$languages->infoNotaCredito->numDocModificado.'</td></tr>';
$html.='<tr><td width="140px" colspan="3">Fecha Emisión (Comprobante a modificar)</td><td>'.$languages->infoNotaCredito->fechaEmision.'</td></tr>';
$html.='<tr><td width="140px" colspan="3">Razón de Modificación:</td><td>'.$languages->infoNotaCredito->motivo.'</td></tr>';
$html.='</table></div><br>';
...
$html.='<tr><td colapan=3>DESCUENTO</td><td align="right">'.$languages->infoNotaCredito->totalDescuento.'</td></tr>';
$html.='<tr><td colapan=3>IVA 12%</td><td align="right">'.$languages->infoNotaCredito->totalConImpuestos->totalImpuesto->valor.'</td></tr>';

$html.='<tr><td colapan=3 >VALOR TOTAL</td><td  align="right" width="120px">'.$languages->infoNotaCredito->importeTotal.'</td></tr>';
$html.='</table>';
return $html; 
}
...
$this->fnLeerNotaCredito($languages); 
...
$img=Yii::app()->basePath.'/../themes/cupcake/img/logo.png';
$header ='
<table width="100%" style="border-bottom: 1px solid #000088; vertical-align: bottom; font-family: serif;">
<tr><td width="36%"><img src= "'.$img.'" height="85px"/></td></tr></table>';
Yii::app()->ePdf->mpdf();  
...
else {$mpdf->Output($arc,'D'); $mpdf->Output($ruta.'/'.$arc,'F');}
