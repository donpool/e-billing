...
class Documentos extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('doc_codigo, usr_codigo, doc_clave_acceso, doc_cod_doc, doc_fecha_emision, doc_valor_total, doc_estado, doc_fecadd, doc_fecupd, usr_codigoupd, doc_numerodelibro, doc_estadopago, doc_formapago, doc_comisiona, doc_comision_notario, doc_comision_matrizador, doc_retencion, doc_ret_iva, doc_ret_ir', 'safe', 'on'=>'search'),
		);
	}
